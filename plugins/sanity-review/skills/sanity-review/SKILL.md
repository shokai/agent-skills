...
3. subagent-consultationも利用できない場合（スキルがインストールされていない等）は、main agentが単独で作業を実行する。報告書の「レビュー作業において発生した問題」セクションに、外部Agentが利用できなかった旨を記載する
...
- **codex-consultation**: Codex CLIと相談するスキル。手順3・手順4・手順5で外部Agentの第一候補として使用する
